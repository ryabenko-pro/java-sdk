...
abstract class Client<B, C> {
    ...
    public void connect(Consumer<Throwable> onConnectionError) throws RuntimeException {
        ...
        if (connectionConfig.isResumable) {
    ...
    protected abstract byte[] serializeSetupPayload(ClientOpts opts);
                ...
                public void subscribe(CoreSubscriber<? super Payload> subscriber) {
                    try {
                        ...
                        if (notificationHandler != null) {
                            reply = notificationHandler.apply(notification); // TODO: This handler should bubble up to end-user with event-specific impl.
                        }
